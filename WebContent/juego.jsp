     ...
     <!--********************************************* Main start *********************************************-->
            ...
            <div id="full_page_wrapper">
                ...
                <% 
	                if(pagina==1){
	                %>
	                <li><a href="ServletRegistrarJuego?idUsuario=<%out.print(session.getAttribute("idUsuario")); %>" rel="gallery" ><img alt="añadir Juego" src="system/juego/new.png" height="200px" width="200px" /></a></li>
                ...
                for(x=x*10;x<tama&&x<w;x++){ 
    				...
    				String video=valores[2];
		    				...
		    				%>
		    				<li><a class="shadowbox" href="ServletJuego?id=<% out.print(idjuego);  %>"  rel="main_gallery" ><img alt="<%out.print(juego); %>" src="system/juego/<%out.print(idjuego); %>-2.png" height="250px" width="250px"/></a></li>
		                	<%
                    } %>
               </ul>
               <%} %>
