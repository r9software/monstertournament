    ...
    <!--********************************************* Mainmenu end *********************************************--> 
     ...
     <div id="main_news_wrapper">
       ...
       <!-- Left wrapper Start -->
        <div id="left_wrapper">
            <div class="header">
            <h2><span>Monster Tournament //</span>CLANES</h2>
            </div>
            <%
            String regex="-.....-"; 
            ...
            <li>
              ...
              <div class="image"><a href="crearclan.jsp"><img alt="Crea un clan" src="./system/clan/default.png" height="250px" width="250px" /></a></div>
            ...
            -->
              <div class="info">
                ...
                <h2><a href="">Crea tu propio clan</a></h2>
                <div class="date_n_author">Organiza tus partidas</a> </div>
                <p>Despues de organizarlo invita a todos tus amigos<br>
                Lleva a tu equipo a ser el mejor, juega contra otros clanes
                y muchas cosas mas.
                
                
                
                </p>
                <a href="crearclan.jsp" class="read_more2">&iexcl;Crea el clan!</a> </div>
                <div class="clear">
                </div>
            ...
            for(x=x*10;x<tama&&x<w;x++){
				...
				String idclan=valores[2];
				String clan=valores[3];
				String clandescripcion=valores[4];
				String avatar=valores[5];
				String ganadas=valores[6];
				String perdidas=valores[7];
				String empatadas=valores[8];
				String etiqueta=valores[9];
				String solicita=valores[10];
            	%>
            
           
            <li>
             
              <div class="image"><a href="./ServletClan?id=<%out.print(idclan); %>"><img alt="<%out.print(clan); %>" src="./system/<%out.print(avatar); %>" height="250px" width="250px" /></a></div>
            ...
            -->
              <div class="info">
                <!--<div class="comments"> 18 </div> -->
                <h2><a href=""><%out.print(clan+"-"+etiqueta); %></a></h2>
                <div class="date_n_author">Creado por-<a href="ServletUsuario?id=<%out.print(idusuario); %>"><%out.print(usuario); %></a> </div>
                <p><%out.print(clandescripcion); %><br>
                Partidas Ganadas: <%out.print(ganadas); %><br>
                Partidas Perdidas: <%out.print(perdidas); %><br>
                Partidas Empatadas: <%out.print(empatadas); %><br>
                <%
                if(Integer.valueOf(solicita)==1)
                {
                %>
                <b>Este clan permite que env&iacute;es una <br>solicitud de registro</b>
                <%
                }
                else{ 
                %>
                <b>Este clan es privado</b>
                <%
                }
                %>
                </p>
                <a href="./ServletClan?id=<%out.print(idclan); %>" class="read_more2">&iexcl;Conoce el clan!</a> </div>
                <div class="clear">
                </div>
          ...
          <ul id="pager">
            ...
            <li><a href="ServletClan?pagina=<%out.print(y); %>" class="active"><%out.print(y);%></a></li>
            <% }else{%>
            <li><a href="ServletClan?pagina=<%out.print(y); %>" ><%out.print(y); %></a></li>
