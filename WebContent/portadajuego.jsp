     ...
     <div id="main_news_wrapper">
       ...
       <!-- Left wrapper Start -->
        <div id="left_wrapper">
                ...
                %>
                    ...
                    <div id="body">
                        ...
                        <div class="post-review">
                        	<h2 style="padding-left: 10%;padding-bottom: 7%;"><%out.print(nombrejuego); %></h2>
			...
			%>
              <li>
                <div class="img"><a href="ServletJuego?id=<%out.print(idjuego2);%>"><img alt="alt_example" src="./system/juego/<%out.print(idjuego2);%>-2.png" /></a></div>
