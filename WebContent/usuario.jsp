...
<%@page import="data.UtilBasesUsuario"%>
    ...
    <!--********************************************* Mainmenu end *********************************************--> 
     ...
     <div id="main_news_wrapper">
       ...
       <!-- Left wrapper Start -->
        <div id="left_wrapper"> 
            <div class="header">
            <h2><span>Monster Tournament //</span>Usuarios</h2>
            </div>
            <%
           ...
           <%
            ...
            for(x=x*10;x<tama&&x<w;x++){
            	...
            	//usuario.id,usuario.usuario,usuario.avatar,
            	//usuario.ganadas,usuario.perdidas,usuario.empatadas,
            	//usuario.clan_id,usuario.torneosganados,clan.nombre
				...
				String clan=valores[8];
				String torneosganados=valores[7];
				String clanid=valores[6];
				if(!idusuario.equals(session.getAttribute("idUsuario").toString()))
				{
            	%>
            ...
            <li>
              ...
              <div class="image"><a href="./ServletUsuario?id=<%out.print(idusuario); %>"><img alt="<%out.print(usuario
            		  ); %>" src="./system/<%out.print(avatar); %>" height="250px" width="250px" /></a></div>
            ...
            -->
              <div class="info">
                ...
                {
                	%>
                    <%out.print("Este usuario aun no tiene clan"); %></div>
                    <%
                }
                else{
                	%>
                    Clan-<a href="ServletClan?id=<%out.print(clanid); %>">
                    <%out.print(clan); %></a> </div><% 
                }%>
                <p>Partidas Ganadas:<%out.print(ganadas); %><br>
                Partidas Perdidas:<%out.print(perdidas); %><br>
                Partidas Empatadas:<%out.print(empatadas); %><br>
                Torneos Ganados:<%out.print(torneosganados); %><br>
                
                
                </p>
                <%
                if(idusuario.equals(session.getAttribute("idUsuario"))){
	    	  	%>
                <a href="./ServletPortada?id=<%out.print(idusuario); %>" class="read_more2">&iexcl;Conoce al Usuario!</a> </div>
                <%
                }
                else{
                %>
                <a href="./ServletUsuario?id=<%out.print(idusuario); %>" class="read_more2">&iexcl;Conoce al Usuario!</a> </div>
                <%
                }
                %>
                <div class="clear">
          ...
          <ul id="pager">
            ...
            <li><a href="ServletUsuario?pagina=<%out.print(y); %>" class="active"><%out.print(y);%></a></li>
            <% }else{%>
            <li><a href="ServletUsuario?pagina=<%out.print(y); %>" ><%out.print(y); %></a></li>
