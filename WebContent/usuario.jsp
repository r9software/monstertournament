            ...
            -->
              <div class="info">
                ...
                if(idusuario.equals(session.getAttribute("idUsuario"))){
	    	  	%>
                <a href="./ServletPortada?id=<%out.print(idusuario); %>" class="read_more2">&iexcl;Ver m&aacute;s!</a> </div>
                <%
                }
                else{
                %>
                <a href="./ServletUsuario?id=<%out.print(idusuario); %>" class="read_more2">&iexcl;Ver m&aacute;s!</a> </div>
                <%
                }
                %>
                <div class="clear">
